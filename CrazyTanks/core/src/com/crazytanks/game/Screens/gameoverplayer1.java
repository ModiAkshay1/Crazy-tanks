...
public class gameoverplayer1 implements Screen {
    ...
    public gameoverplayer1(final crazytanks Game){
        this.game1=Game;
        backimage = new Texture(Gdx.files.internal("gameoverplayer1.png"));
